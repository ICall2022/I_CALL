    ...
    return ResponsiveWidgets.builder(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: const [
              TextResponsive('I CALL'),
            ],
          ),
          actions: [

            Padding(
              padding:  EdgeInsetsResponsive.only(top: 38.0,bottom: 18,right: 15.0),
          ...
          child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context,  chaid) {
                ...
                if(chaid.data.docs.length<1){
                  return Center(
                    child: Padding(
                      padding:  EdgeInsetsResponsive.only(top: 380.0),
                      child: ContainerResponsive(
                        child: Stack(
                          ...
                          children: [
                            Image.asset("assets/newchat.png",),
                             Padding (
                              padding:  EdgeInsetsResponsive.symmetric(vertical: 8.0,horizontal: 35),
                              child:  TextResponsive("Click here to start a \n new chat",textAlign: TextAlign.center,
                              ...
                              children: [
                                ListTile(
                                    leading: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          placeholder: (context, url) => ContainerResponsive(
                                            ...
                                            child: ContainerResponsive(width: 60,height: 80,
                                    ...
                                    title: ContainerResponsive(
                                      ...
                                      child: TextResponsive(userData['name'],overflow: TextOverflow.ellipsis,  maxLines: 1,
                                        softWrap: false,
                                        style: TextStyle(fontSize: 20,
                                            fontWeight: FontWeight
                                                .bold),),
                                    ),
                                    subtitle: ContainerResponsive(
                                      child: TextResponsive(userData['lastchat'],overflow: TextOverflow.ellipsis,  maxLines: 1,
                                        style: TextStyle(
                                          fontSize: 16,
