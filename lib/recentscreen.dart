...
class recentscreen extends StatefulWidget {
  ...
  String phone;
  recentscreen(this.nameuser,this.Imgurl,this.chatno,this.collectionStream,this.phone);
...
// sized box with width 10
      ...
      body: widget.chatno == 1 ? RefreshIndicator(
        onRefresh: (){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => recentscreen(widget.nameuser,widget.Imgurl,widget.chatno,widget.collectionStream,widget.phone)));
